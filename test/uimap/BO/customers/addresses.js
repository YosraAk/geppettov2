module.exports = {
  AddressesPage: {
    ...
    addresses_success_alert: '#content > div.bootstrap > div[class*=success]',
    addresses_danger_alert: '#content > div.bootstrap > div[class*=alert-danger]',
    addresses_filter_address_input_field: '#form-address input[name=addressFilter_address1]',
    addresses_address_column: '#table-address tr:nth-of-type(%ROW) td:nth-of-type(%COL)',
    addresses_set_required_fields_link: 'a[onclick*=requiredFieldsParameters]',
    addresses_company_checkbox: ' input[value="company"]',
    addresses_save_required_fields_button: 'button[name*=submitFields]',
    addresses_check_all_required_fields_checkbox: 'input[name*=checkme]',
    ...
    addresses_empty_bloc: '#table-address div[class*=list-empty-msg]',
    ...
    addresses_delete_selected_link: 'div[class*=bulk-actions] a[onclick*=submitBulkdeleteaddress]',
  }
};