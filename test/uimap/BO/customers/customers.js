module.exports = {
  CustomersPage: {
    ...
    customers_birthday_day_select: '#fieldset_0 select[name=days]',
    customers_birthday_month_select: '#fieldset_0 select[name=months]',
    customers_birthday_year_select: '#fieldset_0 select[name=years]',
    customers_partner_offers_yes_label: '#fieldset_0 label[for*=optin_on]',
    customers_save_button: '#customer_form_submit_btn',
    customers_success_alert: '#content > div.bootstrap > div[class*=success]',
    customers_filter_email_input_field: '#form-customer input[name=customerFilter_email]',
    ...
    customers_delete_button: '#content input[value=Delete]',
    customers_empty_bloc: '#table-customer div[class*=list-empty-msg]',
